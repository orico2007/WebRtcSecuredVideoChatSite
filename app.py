...
SESSION_TTL_SECONDS = int(os.environ.get("SESSION_TTL_SECONDS"))  # 5 hours
...
CF_TURN_TTL = int(os.environ.get("CLOUDFLARE_TURN_TTL", "900"))  # 15 min
...
def cf_generate_ice_servers(ttl_seconds: int):
    ...
    # Cloudflare returns iceServers in the response
...
def api_ice(req: HTTPRequest):
    ...
    # enforce: user is owner or joined
